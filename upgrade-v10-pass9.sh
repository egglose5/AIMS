...
echo "Building Ancient Innovations Control App v10 Pass 9 - Show Arm Foundation..."
...
echo "v10 Pass 9 is running at http://localhost:8080"
echo "Open Show Arm in the left menu, then click 'Load our vendor profiles' once."
