...
echo "Building Ancient Innovations Control App v10 Pass 8.6..."
...
echo "v10 Pass 8.6 is running at http://localhost:8080"
echo "DYMO print pages are fixed at exactly 2.00 x 0.75 inches for inventory and customer-order labels."
