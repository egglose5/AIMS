...
final class InventoryTransferServiceTest extends \AIMS\Tests\TestCase {
	...
	public function testCreateDraftRejectsIdenticalSourceAndTargetNodes(): void {
		$service = new \AIMS_Inventory_Transfer_Service( null, null, null, null, $this->build_transfer_auth() );
		$result  = $service->create_draft(
			10,
			10,
			array(
				'source_node_type' => 'vendor',
				'target_node_type' => 'vendor',
			)
		);

		$this->assertFalse( $result['success'] );
		$this->assertSame( 'same_source_target', $result['code'] ?? '' );
	}
	...
	public function testDispatchTransferAllowsSourceBoundaryAuthorityWithoutTargetCreateAccess(): void {
		$transfer_repo = new class() extends \AIMS_Inventory_Transfer_Repository {
		...
		$service = new \AIMS_Inventory_Transfer_Service( $transfer_repo, $items_repo, $custody_service, null, $auth );
	...
	public function testConfirmReceiptAllowsTargetBoundaryAuthorityWithoutSourceCreateAccess(): void {
		$transfer_repo = new class() extends \AIMS_Inventory_Transfer_Repository {
