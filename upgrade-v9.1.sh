...
cd "$ROOT"
echo "Building and starting v9.1..."
...
echo
echo "v9.1 is running at http://localhost:8080"
echo "Square history fix installed. Deleted historical catalog items no longer abort sales sync."
